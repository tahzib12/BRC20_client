...
function DataProviders() {
  return (
    <div>
        ...
        <div className='col-md-6 d-flex flex-column  justify-content-start mt-5 ml-3'> 
          <div className='text-white text-7xl text-left'>Meet our visionaries</div>
          <p className='text-white w-[300px] text-left'>Learn more about our coalition of first-party publishers.</p>
        </div>
